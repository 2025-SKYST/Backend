...
from mysol.app.subscription.service import SubscriptionService
...
async def get_my_subscriptions(
    ...
    """
    per_page = 10
    return await subscribe_service.get_paginated_subscribed_blogs(
        subscriber=user,
        page=page,
        per_page=per_page
    )
...
async def get_my_subscribers(
    ...
    """
    per_page=10
    return await subscribe_service.get_paginated_subscriber_blogs(
        subscribed=user,
        page=page,
        per_page=per_page
    )
