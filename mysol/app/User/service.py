...
class UserService:
    def __init__(self, user_store: Annotated[UserStore, Depends()], blog_store: Annotated[BlogStore, Depends()]) -> None:
    ...
    async def add_user(self, email: str, password: str, username: str) -> User:
        ...
        await self.blog_store.add_blog(user_id=user.id, blog_name=blogname, description=blogdescription)
