...
from mysol.app.like.dto.requests import LikeCreateRequest
from mysol.app.like.dto.responses import LikeDetailInListResponse, LikeDetailResponse
from mysol.app.like.service import LikeService
...
async def delete_like(
    ...
    await like_service.delete_like_in_article(user, article_id)
