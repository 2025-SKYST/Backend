...
from mysol.app.notification.store import NotificationStore
from mysol.app.notification.dto.responses import NotificationResponse, PaginatedNotificationListResponse
from mysol.app.notification.errors import NotificationNotFoundError
from mysol.app.user.service import UserStore
from mysol.app.blog.service import BlogStore
...
class NotificationService:
    ...
    async def add_notification(
        ...
        blogs = [
            await self.blog_store.get_blog_by_id(id)
            for id in blog_ids
        ]
